...
for exp in exp_seeds:
    ...
    for task_month in range(len(all_task_months)):
        ...
        results_f = open(os.path.join(results_save_dir + 'next_1_results_accumulated_replay_' + str(num_samples_per_malware_family) + '_results.txt'), 'a')
