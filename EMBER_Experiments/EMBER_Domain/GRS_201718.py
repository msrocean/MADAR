...
#         if '2017' in current_task:
#             data_dir = "../../../ember2017/EMBER2017withFamilyLabels/"
#         else:
#             data_dir = '../../../month_based_processing_with_family_labels/'
        ...
        results_f = open(os.path.join('./Submission_201718_Domain/' + 'grs_' + str(memory_budget) + '_results.txt'), 'a')
