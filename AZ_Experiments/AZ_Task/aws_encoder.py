...
class AZ_MLP_Net_V2(nn.Module):
    def __init__(self):
        super(AZ_MLP_Net_V2, self).__init__()
...
class Classifier(ContinualLearner, Replayer, ExemplarHandler):
    ...
    def __init__(self, image_size, image_channels, classes,
        ...
        sizes_layers = [2439, 1024, 512, 256, 128]
        
        #[1024, 512, 256, 128]
        # fully connected hidden layers
        
        
        self.fcE = AZ_MLP_Net_V2()
        
        mlp_output_size = fc_units if fc_layers>1 else image_channels*image_size**2

        # classifier
        self.classifier = AZ_Classifier(128, classes)
