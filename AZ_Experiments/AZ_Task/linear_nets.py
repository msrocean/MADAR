...
class AZ_MLP_Net(nn.Module):
    def __init__(self):
        ...
        input_features = 2439
        self.fc0 = nn.Linear(input_features, 2048)
        self.fc0_bn = nn.BatchNorm1d(2048)
        self.act0 = nn.ReLU()
        # self.fc0_drop = nn.Dropout(p=0.5)
...
class AZ_MLP_Net_V1(nn.Module):
    def __init__(self):
        super(AZ_MLP_Net, self).__init__()
        
        input_feats_length = 2439
        self.fc01 = nn.Linear(input_feats_length, 2048)
...
class AZ_Classifier(nn.Module):
    def __init__(self, input_feats_length, output_classes):
        super(AZ_Classifier, self).__init__()
...
class Drebin_MLP_Net(nn.Module):
    def __init__(self, input_feats_length, output_feats):
        super(Drebin_MLP_Net, self).__init__()
        self.input_feats_length = input_feats_length
        self.output_feats = output_feats
        
        self.fc1 = nn.Linear(self.input_feats_length, 1024)
        self.fc1_bn = nn.BatchNorm1d(1024)
        self.fc1_drop = nn.Dropout(p=0.5)
        self.act1 = nn.ReLU()
        ...
        self.fc4 = nn.Linear(256, self.output_feats)
        self.fc4_bn = nn.BatchNorm1d(self.output_feats)
        self.fc4_drop = nn.Dropout(p=0.5)
        self.act4 = nn.ReLU()
...
class Drebin_Classifier(nn.Module):
    def __init__(self, input_feats_length, output_classes):
        super(Drebin_Classifier, self).__init__()
        self.input_feats_length = input_feats_length
        self.output_classes = output_classes
