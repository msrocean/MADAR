...
from linear_nets import MLP, fc_layer, AZ_MLP_Net, AZ_Classifier
...
class Classifier(ContinualLearner, Replayer, ExemplarHandler):
    ...
    def __init__(self, image_size, image_channels, classes,
        ...
        sizes_layers = [2439, 2048, 1024, 512, 256, 128]
        
        #[1024, 512, 256, 128]
        # fully connected hidden layers
        
#         self.fcE = MLP(input_size=2381, output_size=fc_units, layers=fc_layers-1,
